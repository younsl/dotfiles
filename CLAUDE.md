...
### Bootstrap and Setup
- **Install dotfiles**: `./scripts/bootstrap/bootstrap-dotfiles.sh` - Creates 14 symbolic links, installs pre-commit hooks, and configures brew autoupdate (86400s interval). Shows preview before execution and requires confirmation.
...
The COMPONENTS array in `bootstrap-dotfiles.sh:5-20` defines these mappings:
```
