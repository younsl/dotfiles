...
#----------------------------------
# Custom prompt (remove username)
#----------------------------------
# Override the default prompt to exclude username
setopt PROMPT_SUBST
PROMPT='$(kube_ps1)%~$(git_prompt_info)$'
...
#----------------------------------
alias c=claude
alias ralph='while :; do cat PROMPT.md | claude ; done'
...
# eks-node-viewer
#----------------------------------
alias eks-node-viewer="eks-node-viewer -resources cpu,memory"
